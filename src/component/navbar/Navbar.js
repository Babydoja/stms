  ...
  return (
    <div>
        <div className="sidebar" id="sidebar">
            ...
            <li className=''><Link to="/"><i className='feather-grid'></i> Dashboard</Link></li>
            <li className="submenu">
            {/* <li className="submenu active"> */}
            {/* <a href="#"><i className="feather-grid"></i> <span> Dashboard</span> <span className="menu-arrow"></span></a> */}
            {/* <a href="#"><i className="feather-grid"></i> <span><li><Link to='/' >Dashboard</Link></li></span></a> */}
            <ul>
            {/* <li><a href="index.html" >Admin Dashboard</a></li> */}
            {/* <li><Link to='/' className="active">Admin dashboard</Link></li> */}
            {/* <li><a href="teacher-dashboard.html">Teacher Dashboard</a></li> */}
            {/* <li><a href="student-dashboard.html">Student Dashboard</a></li> */}
            {/* <li><Link to='/studentdash'>student dashboard</Link></li> */}
            </ul>
            </li>
            <li className="">
            <Link to="/studentlist"><i className="fas fa-graduation-cap"></i> <span> Students</span> </Link>
            <ul>
            ...
            <li className="">
            <Link to='/listcourse'><i className="fas fa-book-reader"></i> <span> Courses</span> </Link>
            <ul>
            {/* <li><a href="subjects.html">Subject List</a></li><span className="menu-arrow"></span> */}
            {/* <li><Link to='/listcourse'>Course List</Link></li> */}
