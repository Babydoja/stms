  ...
  return (
    <div>
        <div class="page-wrapper">
            ...
            <Link to='/studentadd' class="btn btn-primary"><i class="fas fa-plus"></i></Link>
            </div>
            </div>
            </div>
            ...
            <Link to='/studentedit' class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"/></Link>
            {/* <a href="student-details.html">Aaliyah</a> */}
            <Link to='/studentedit'>Aaliyah</Link>
            </h2>
            </td>
            <td>Web design</td>
            {/* <td>2 Feb 2002</td>
            ...
            <Link to="/studentedit" class="btn btn-sm bg-danger-light">
            ...
            <h2 class="table-avatar">
            <Link to='/studentedit' class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-01.jpg" alt="User Image"/></Link>
            <Link to='/studentedit'>Malynne</Link>
